...
//	LISTE AUFBAUEN
//
void CEricFormularlogikUStVA::UpdateListe(CString &csFormularDateipfad, CString& csBetrieb, CString (&ListeInhalt)[500][6], CQuickList* pListe, BOOL bNurSpaltenbreitenAnpassen)
{
	m_pListe = pListe;
